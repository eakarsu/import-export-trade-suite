...
export const sourceSystems = [
  { name: 'AIImportExportTradeAssistant', ownership: 'Records source capabilities and workflows', coverage: ['Records', 'Workspaces', 'Requests'] },
  { name: 'AIImportExportTradeOperations', ownership: 'Workspaces source capabilities and workflows', coverage: ['Cases', 'Schedules', 'Resources'] },
  { name: 'AIImportExportTradeAnalytics', ownership: 'Requests source capabilities and workflows', coverage: ['Approvals', 'Exceptions', 'Compliance'] },
  { name: 'AIImportExportTradeWorkflow', ownership: 'Cases source capabilities and workflows', coverage: ['Analytics', 'Forecasts', 'Reports'] },
];
