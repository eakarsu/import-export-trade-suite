...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Import Export Trade suite with records, queues, approvals, audit, and reporting.',
  ...
  {
    slug: "restricted-party-screening",
    title: "Restricted Party Screening",
    href: "/restricted-party-screening",
    category: "Export Control Sanctions",
    icon: Workflow,
    summary: "Counterparty, sanctions list, denied party, and match confidence review.",
    bullets: ["Restricted Party Screening queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Restricted Party Screening", value: "28", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "3", note: 'Next 14 days' },
    ],
  },
  {
    slug: "export-control-classification",
    title: "Export Control Classification",
    href: "/export-control-classification",
    category: "Export Control Sanctions",
    icon: Workflow,
    summary: "Product classification, destination controls, end use, and license needs.",
    bullets: ["Export Control Classification queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Export Control Classification", value: "39", note: 'Active' },
      { label: 'Review', value: "6", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "trade-compliance-case",
    title: "Trade Compliance Case",
    href: "/trade-compliance-case",
    category: "Export Control Sanctions",
    icon: Workflow,
    summary: "Escalations, evidence, approvals, and shipment hold/release decision.",
    bullets: ["Trade Compliance Case queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Trade Compliance Case", value: "50", note: 'Active' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Import Export Trade documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Import Export Trade alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Import Export Trade source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Import Export Trade users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Import Export Trade assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'Export Control Sanctions', features: ["Restricted Party Screening","Export Control Classification","Trade Compliance Case"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIImportExportTradeAssistant', 'AIImportExportTradeOperations where applicable'],
