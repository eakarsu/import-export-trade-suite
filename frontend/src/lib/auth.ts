export const AUTH_COOKIE = 'import_export_trade_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@import-export-trade.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@import-export-trade.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@import-export-trade.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
