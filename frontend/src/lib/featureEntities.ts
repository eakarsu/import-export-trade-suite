...
const entitySeeds = [
  ...
  ["restricted-party-screening","Restricted Party Screening Records","Restricted Party Screening operating queue","Open","Restricted Party Screening follow-up list","Export Control Sanctions","$0"],
  ["export-control-classification","Export Control Classification Records","Export Control Classification operating queue","Review","Export Control Classification follow-up list","Export Control Sanctions","$0"],
  ["trade-compliance-case","Trade Compliance Case Records","Trade Compliance Case operating queue","Review","Trade Compliance Case follow-up list","Export Control Sanctions","$0"],
