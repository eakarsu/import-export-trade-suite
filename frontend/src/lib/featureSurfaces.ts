...
const featureSeeds = [
  ...
  ["restricted-party-screening","Restricted Party Screening","Restricted Party Screening review queue","Export Control Sanctions","Review source context and assign owner"],
  ["export-control-classification","Export Control Classification","Export Control Classification review queue","Export Control Sanctions","Confirm next action and update evidence"],
  ["trade-compliance-case","Trade Compliance Case","Trade Compliance Case review queue","Export Control Sanctions","Confirm next action and update evidence"],
