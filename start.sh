...
PORT="${PORT:-5410}"
DB_NAME="${PGDATABASE:-import_export_trade_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Import Export Trade Suite"
echo "======================================="
echo
...
echo "Starting import export trade suite frontend on http://localhost:$PORT"
echo "Login: admin@import-export-trade.local / admin123"
